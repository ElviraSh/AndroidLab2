...
public class NewsActivity extends AppCompatActivity {
    ...
    LinearLayout.LayoutParams linearLayot;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        linearLayot = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
        getNewsAndShowThem();
    }
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            if (holder instanceof NewsViewHolder) {
                ...
                Glide.with(mContext).load(news.getPublisher().getPhoto_200())
                        .fitCenter()
                        .into(((NewsViewHolder) holder).img);
            }
        }
    ...
    private class NewsViewHolder extends RecyclerView.ViewHolder {
        ...
        public NewsViewHolder(View itemView) {
            super(itemView);
            layout = (LinearLayout) findViewById(R.id.news_news_ll);
        ...
        public void bind(VkNewsItem news, Context mContext) {
            ...
            String inf = news.getText();
            fullText = inf;
            if(inf != null) {
                if (inf.length() > 301) {
                    inf = inf.substring(0, 300) + "...";
                }
            } else {
                inf = "";
            }
            ...
            if(imageViewList != null && layout != null){
            ...
            if(attachments != null){
                for(VkAttachments att : attachments){
                    String photo = null;
                    if(att != null){
                        photo = getMaxPhoto(att.getPhoto());
                    }
                    if(photo != null){
                        try {
                            ImageView imageView = new ImageView(mContext);
                            imageView.setLayoutParams(linearLayot);
